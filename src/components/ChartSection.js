            ...
            Price: {
                options: {
                    ...
                    grid: {
                        ...
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "#7FC693", padding: "10px"
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
            ...
            , Market_Cap: {
                options: {
                    grid: {
                        ...
                        text: "Market Capital (INR)",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: '#00AECF'
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
            ...
            Tot_Vol: {
                options: {
                    grid: {
                        ...
                        text: "Market Volume",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "#FF555F"
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
                    ...
                    <div className="row">
                        <div className="col" style={{ maxWidth: '610px' }}>
                            <div id="chart">
                                <div className="toolbar">
                                    ...
                                    &nbsp;
                                    <button id="six_months" style={{ borderRadius: "5px", backgroundColor: "#10548C" }}

                                        onClick={() => this.setState({ Price: { options: { ...this.tooltip, selection: 7 }, series: this.state.Price.series } })}>
                                        1W
                                    </button>
                                    &nbsp;
                                    <button id="one_year" style={{ borderRadius: "5px", backgroundColor: "#10548C" }}
                                    ...
                                    &nbsp;
                                    <button id="ytd" style={{ borderRadius: "5px", backgroundColor: "#10548C" }}

                                        onClick={() => this.setState({ Price: { options: { ...this.tooltip, selection: 182 }, series: this.state.Price.series } })}>
                                        6M
                                    </button>
                                    &nbsp;
                                    <button id="all" style={{ borderRadius: "5px", backgroundColor: "#10548C" }}
                        ...
                        <div className="col" style={{ maxWidth: '200px' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{ fontFamily: 'Arvo' }}> Market Cap </h6>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{ fontFamily: 'Arvo' }}> Price Change 24hrs </h6>
                                <p className="card-text fw-bold "
                                    style={{ fontFamily: 'Arvo', color: 'rgb(255, 255, 255)', fontSize: 'small' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{ fontFamily: 'Arvo' }}> Total Volume </h6>
                                <p className="card-text fw-bold "
                                    style={{ fontFamily: 'Arvo', color: 'rgb(255, 255, 255)', fontSize: 'small' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{ fontFamily: 'Arvo' }}> Circulating Supply</h6>
                                <p className="card-text fw-bold "
                                    style={{ fontFamily: 'Arvo', color: 'rgb(255, 255, 255)', fontSize: 'small' }}>
